...
package io.github.thierrysquirrel.network.aspect;


import io.github.thierrysquirrel.network.annotation.DeleteRequest;
import io.github.thierrysquirrel.network.annotation.GetRequest;
import io.github.thierrysquirrel.network.annotation.PostRequest;
import io.github.thierrysquirrel.network.annotation.PutRequest;
import io.github.thierrysquirrel.network.autoconfigure.NetworkProperties;
import io.github.thierrysquirrel.network.core.utils.AspectUtils;
import io.github.thierrysquirrel.network.intercept.InterceptRequest;
import lombok.Data;
...
public class NetworkAspect {
	...
	@Pointcut("@annotation(io.github.thierrysquirrel.network.annotation.GetRequest)")
	public void getRequestAspect(){}

	@Pointcut("@annotation(io.github.thierrysquirrel.network.annotation.PostRequest)")
	public void postRequestAspect(){}

	@Pointcut("@annotation(io.github.thierrysquirrel.network.annotation.PutRequest)")
	public void putRequestAspect(){}

	@Pointcut("@annotation(io.github.thierrysquirrel.network.annotation.DeleteRequest)")
